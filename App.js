...
import dscontract from '../../../blockchain/Decentra.js';
...
const initWeb3 = async () => {
    if (window.ethereum) {
      ...
      try {
        ...
        const address = dscontract.networks[netId].address;
        const contract = new web3.eth.Contract(dscontract.abi, address);
